...
### La mayoria de las actividades científicas implican una forma de modelado

### Un marco teórico muchas veces implica un modelo que podría ser formalizado como algoritmo o expresión matemática

### Muchas veces cuando hacemos mediciones también estamos aplicando modelos!!

### Debemos ser concientes de esto modelos que estamos aplicando

### Los modelos estadísticos usuales son llamados estáticos.

### Los modelos dinámicos incluyen el cambio de las variables de estado en el tiempo 
...
* Simular el modelo en que los individuos solo mueren.

--

* Hacer que la tasa de nacimiento o mortalidad dependa de un factor externo, por ejemplo la temperatura.
